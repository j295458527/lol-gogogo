...
module.exports = function () {
	...
	var _obj2Params = function _obj2Params(obj, startTag) {
		var result = startTag;
		for (var key in obj) {
			result += key + '=' + obj[key] + '&';
		}
	...
	var upLoadData = function upLoadData(options) {
		this.setData({
			tarUploadSrc: "http://api.scrm.weisgj.com/wxtags/batchuntag?&random=" + Math.random() + _obj2Params('&')
		});
	};
	// this作为page的options方法
	var wrapActionHandle = function wrapActionHandle(actionFuncName, eventParams) {
